...
function love.load()
	...
	click:setTextByClass("menu", {text={space=math.rad(5),size = 60, file = "font/FrancoisOne-Regular.ttf",color={r=0,g=0,b=0,a=255}}})
	...
	click:setTextByClass("menu1", {text = {space = math.rad(3.5), file = "font/FrancoisOne-Regular.ttf", size=70, 
